...
const Home: NextPage = () => {
  return (
    <>
      <Head>
        <title>Ron San Jose</title>
        <meta
          name="description"
          content="Software Engineer crafting great user experiences."
        />
      ...
      <main className="container">
        ...
        <ul className="links-list">
          {/* <li>Resume</li> */}
          <li>
            <a href="https://www.linkedin.com/in/ronsanjose/">
              <LinkedInIcon />
              LinkedIn
            </a>
          </li>
        ...
        {/* <div className="latest-commit">Latest Commit:</div> */}
      </main>
    </>
  )
}
